...
import (
	...
	"github.com/lccooronel/graphql-full-cycle/graph/generated"
	"github.com/lccooronel/graphql-full-cycle/graph/model"
)
...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	...
	for _, item := range r.Resolver.Courses {
		if item.Category.ID == obj.ID {
...
func (r *courseResolver) Chapters(ctx context.Context, obj *model.Course) ([]*model.Chapter, error) {
	...
	for _, item := range r.Resolver.Chapters {
		if item.Course.ID == obj.ID {
